...
'''
import logging
from utils.scripts import find_last_row_in_col
from datetime import datetime
import openpyxl
from openpyxl.styles import Font, Alignment, Border, Side
from utils.scripts import load_excel, format_row, format_datetime
...
def format_excel_outer(json_data):
    ...
    workbook = load_excel('excel/templates/template_outer.xlsx')
