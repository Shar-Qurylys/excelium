...
Doc-V опрашивает /jobs/pending точкой на планировщике (30 с), создаёт
документы из полученного JSON и подтверждает /jobs/ack. Дубль при
повторной выдаче гасится на стороне Doc-V выборкой по job_id перед
